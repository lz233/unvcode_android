...
package com.google.code.appengine.awt.geom.impl;

public interface PathConsumer2D {
    /**
     * @see org.openawt.geom.Path2D.Float.moveTo
     */
    public void moveTo(float x, float y);

    /**
     * @see org.openawt.geom.Path2D.Float.lineTo
     */
    public void lineTo(float x, float y);

    /**
     * @see org.openawt.geom.Path2D.Float.quadTo
     */
    public void quadTo(float x1, float y1,
                       float x2, float y2);

    /**
     * @see org.openawt.geom.Path2D.Float.curveTo
     */
    ...
    /**
     * @see org.openawt.geom.Path2D.Float.closePath
     */
     ...
     * {@link org.openawt.geom.PathIterator PathIterator}
